...
<script type="text/javascript" src="<?php bloginfo( 'template_url' ); ?>/html5gallery/html5gallery.js"></script>
	...
	data-autoplayvideo="true" data-html5player="true">
		...
		<a href="<?php echo $img;?>"><img src="<?php echo $img;?>" alt=""></a>
					...
					<a href="<?php bloginfo( 'template_url' ); ?>/img/banner.png"><img src="<?php bloginfo( 'template_url' ); ?>/img/banner.png" alt=""></a>
					<?php } ?>
		...
		?>
		<a href="<?php echo $vdo;?>"><img src="https://img.youtube.com/vi/<?php echo $video_id; ?>/default.jpg" alt=""></a>
		<?php }} ?>
...
?>				
				...
				<?php if($detect->isMobile() && !$detect->isTablet()):
						...
						<img class="attachment-post-thumbnail size-post-thumbnail wp-post-image img-size" src="<?php bloginfo( 'template_url' ); ?>/img/img-tmp.png" style="width:300px">
					<?php else: ?>
						<img class="attachment-post-thumbnail size-post-thumbnail wp-post-image img-size" style="width:300px" src="<?php echo $ride->thumbnails[0]; ?>">
						<?php endif;
						else: ?>
						<img class="attachment-post-thumbnail size-post-thumbnail wp-post-image img-size" style="width:300px" src="<?php echo $ride->thumbnails[0]; ?>">
					<?php endif; ?>
...
//wp_reset_postdata();?>								
			...
			/* 	require_once get_template_directory().'/inc/tourlib.php';
				...
				<div class="top-rides" style="margin-bottom: 0px; padding:1px">
					...
					<?php else: ?>
						<img class="attachment-post-thumbnail size-post-thumbnail wp-post-image showimg2" src="<?php echo $ride->thumbnails[0]; ?>" style="width:300px; height:259px;">
					<?php endif; ?>
					</a>
...
<div id="myModal" class="modal fade">
	...
	<div class="col-sm-12" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 4px solid rgb(0, 0, 0); padding: 20px;">
                ...
                <form  name="paypalpayment" id="paypalpayment" method="post" onsubmit="javascript:return sendBookingdata();" action="https://www.sandbox.paypal.com/cgi-bin/webscr">
					...
					<input type="hidden" name="business" value="business_001@yopmail.com">
					<input type="hidden" name="rm" value="2">
					<input type="hidden" name="amount_1" id="sendamount" value="<?php echo $price_detail ;?>">
					<input type="hidden" name="no of participants" value="<?php echo $participants;?>">
					<input type="hidden" name="no_shipping" value="0">
					<input type="hidden" name="custom" id="customfield" value="">
					<input type="hidden" name="item_name_1" value="<?php echo $detail->tour->name; ?>">
					...
					<input type="hidden" name="return" value="<?php echo site_url().'/booking'; ?>">
					<input type="hidden" name="cancel_return" value="<?php echo site_url().'/booking'; ?>">
					<input type="hidden" name ="status" value="Completed">
					<input type="hidden" class="detail-date-input" value="<?php echo $saptime; ?>">
					<input type="hidden" class="detail-tourname-input" value="<?php echo $detail->tour->name; ?>">
...
<form  method="post" action="">
				 ...
				 <textarea name="message" id="message" class="form-control" rows="8" placeholder="Enter your message here"></textarea>
                  ...
                  <input type="hidden" name="tourtime" value="<?php echo $detail->sap[0]->time; ?>"> 
					...
					<input type="submit" name="detail" value="SEND" class="btn btn-danger">
