...
<?php
				...
				$token = $tour_login->data['data']->token;
						...
						<div class="alert alert-success">
								...
								<script>window.location = '<?php echo site_url().'/operator-info'; ?>'; </script>
								</div>
								<?php
								}
								else
        ...
        <div class="row">
			...
			<?php if($_SESSION['tourUserSignOutMsg']): ?>
			<div class="alert alert-success fade in"><a title="close" aria-label="close" data-dismiss="alert" class="close" href="#">×</a><strong></strong> <?php echo $_SESSION['tourUserSignOutMsg']; ?></div>
			<?php 
			unset($_SESSION['tourUserSignOutMsg']);
			endif; ?>
				<div class="col-sm-12">
