            ...
            <div class="collapse navbar-collapse">
               ...
               <?php $userdata = empty($_SESSION['rideTourUserData']) ? null : $_SESSION['rideTourUserData']; ?>
				...
				<?php if(empty($userdata->token)): ?>
					<a href="<?php echo site_url();  ?>/login"><button class="btn btn-danger" type="button" style="background: rgb(77, 194, 255) none repeat scroll 0% 0%; border: medium none rgb(77, 194, 255); height: 40px; font-size: 13px;">LOGIN</button></a>
					<a style="margin-left:1px;" href="<?php echo site_url(); ?>/sign-up"><button class="btn btn-danger1" type="button" style="height: 40px; font-size: 13px;">SIGN UP</button></a>
				<?php else: ?>
