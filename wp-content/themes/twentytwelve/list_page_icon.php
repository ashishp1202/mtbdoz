...
<div class="col-lg-8"><h1>TOURS LIST</h1></div><div class="col-lg-4"><a style="float:right;" href="<?php echo site_url().'/create-tour'; ?>" class="btn btn-sm btn-success">Add Tour</a></div>
			...
			<div class="col-sm-12 result img-block">
					...
					<?php if(empty($srch->images[0])): ?>
						<img src="<?php bloginfo( 'template_url' ); ?>/img/img1.png" alt="<?php echo $srch->tour->name; ?>">
					<?php else: ?>
					<?php if($detect->isMobile()): ?>
						<img style="width:140px;height:100px;" src="<?php echo $srch->thumbnails[0]; ?>" alt="<?php echo $srch->tour->name; ?>">
					<?php else: ?>
						<img style="width:140px;height:100px;" alt="<?php echo $srch->tour->name; ?>" src="<?php echo (empty($srch->thumbnails[0])) ? $srch->images[0] : $srch->thumbnails[0]; ?>">
					<?php endif; ?>	
					<?php endif; ?>
					</div>
					<div class="col-sm-6">
