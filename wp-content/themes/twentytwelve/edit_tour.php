						...
						<div class="row">
							...
							<div class="col-lg-12" style="float:left;padding:0;">
								...
								<label>Tour Status:</label>
									<select name="tour_status" class="select-class">
									  <option <?php echo ($tourdetail->tour->status == 'ACTIVE') ? 'selected="selected"' : '' ?> value="ACTIVE">Active</option>
									  <option <?php echo ($tourdetail->tour->status == 'INACTIVE') ? 'selected="selected"' : '' ?> value="INACTIVE">Inactive</option>
									</select>
								</div>
	...
	if(!empty($detail->data->images)){
		foreach($detail->data->images as $img){
			...
			if($thumbTourImage != 'null'){
			 ...
			 if($detect->isMobile()): ?>
			 <li class="list-group-item col-lg-12" style="float:left;"><div class="col-lg-4"><img style="width:140px;height:100px;" src="<?php echo $img->thumbnailImagePath; ?>" title="<?php echo $tourdetail->tour->name; ?>" alt="<?php echo $tourdetail->tour->name; ?>" /></div><div class="col-lg-4"><input type="radio" name="defaultTourImage" class="set-default-tour-image" style="text-align: left;width: 7%;" data-tour-id="<?php echo $detail->data->tourId; ?>" data-tour-imageid="<?php echo $img->imageId; ?>" href="javascript:void(0);" <?php echo ($img->isDefaultImage==true)?'checked':'';?>>Set Tour default Image</div><div class="col-lg-4"><a class="delete-tour-image btn btn-danger btn-sm" data-tour-id="<?php echo $detail->data->tourId; ?>" data-tour-imageid="<?php echo $img->imageId; ?>" href="javascript:void(0);">Delete</a></div></li>

			 <?php else: ?>
			<li class="list-group-item col-lg-12" style="float:left;"><div class="col-lg-4"><img style="width:140px;height:100px;" src="<?php echo $tourImage; ?>" title="<?php echo $tourdetail->tour->name; ?>" alt="<?php echo $tourdetail->tour->name; ?>" /></div><div class="col-lg-4"><input type="radio" style="text-align: left;width: 7%;" name="defaultTourImage" class="set-default-tour-image" data-tour-id="<?php echo $detail->data->tourId; ?>" data-tour-imageid="<?php echo $img->imageId; ?>" href="javascript:void(0);" <?php echo ($img->isDefaultImage==true)?'checked':'';?>>Set Tour default Image</div><div class="col-lg-4"><a class="delete-tour-image btn btn-danger btn-sm" data-tour-id="<?php echo $detail->data->tourId; ?>" data-tour-imageid="<?php echo $img->imageId; ?>" href="javascript:void(0);">Delete</a></div></li>
			<?php 
			endif;
		}
	}
