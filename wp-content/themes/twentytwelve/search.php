					...
					<div class="col-sm-3" style="padding:0 1px;">
						<div class="col-xs-7" style="padding:0px;">
										...
										<?php if(!empty($srch->thumbnails[0])): ?>
											<img style="width:140px;height:85px;" src="<?php echo $srch->thumbnails[0]; ?>" alt="<?php echo $srch->tour->name; ?>">
										<?php else: ?>
											<img style="width:100%;" src="<?php bloginfo( 'template_url' ); ?>/img/img1.png" alt="<?php echo $srch->tour->name; ?>">
										<?php endif; ?>
										</a>
										<?php else: ?>
										<?php if(empty($srch->images[0])): ?>
											<a href="<?php echo site_url();?>/detail/<?php echo $srch->tour->name; ?>/<?php echo $srch->tour->id; ?>/<?php echo $srch->sap[0]->time ?>"><img style="width:100%;" src="<?php bloginfo( 'template_url' ); ?>/img/img1.png" alt="<?php echo $srch->tour->name; ?>"></a>
										<?php else: ?>
											<a href="<?php echo site_url();?>/detail/<?php echo $srch->tour->name; ?>/<?php echo $srch->tour->id; ?>/<?php echo $srch->sap[0]->time ?>"><img style="width:160px;height:100px;" alt="<?php echo $srch->tour->name; ?>" src="<?php echo (empty($srch->thumbnails[0])) ? $srch->images[0] : $srch->thumbnails[0]; ?>"></a>
										<?php endif; ?>
										<?php endif; ?>
									</div>
